        ...
        echo '<div class="tbk-detail-wrapper tbk-detail__'. $this->service_id . '">';
                ...
                ?>
                            <?php 
                                ...
                                //  │                 LEFT SIDE                 │░
                                //  │                                           │░
                                //  │        Title, date, time, images.         │░
                                //  │                                           │░
                                //  └───────────────────────────────────────────┘░
                                //   ░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░

                                echo '<div class="tbk-class-header tbk-class-header__' . $this->service_id . '">';

                                    //  ┌────────────────────────────────────────────────┐
                                    //  │               Navigation arrows                │
                                    //  └────────────────────────────────────────────────┘
                                    echo $this->output_back_arrow();
                                    
                                    echo '<div class="tbk-details">';
                                        //  ┌────────────────────────────────────────────────┐
                                        //  │                     Title                      │
                                        //  └────────────────────────────────────────────────┘
                                        if (!$this->is_checkout) { echo $this->output_title($this); }
                                        
                                        //  ┌────────────────────────────────────────────────┐
                                        //  │                   Day & Date                   │
                                        //  └────────────────────────────────────────────────┘
                                        echo $this->output_day_date();
                                                                
                                        //  ┌────────────────────────────────────────────────┐
                                        //  │              Star / Finish times               │
                                        //  └────────────────────────────────────────────────┘
                                        echo $this->output_start_finish();

                                        //  ┌────────────────────────────────────────────────┐
                                        //  │                  TODAY! Alert                  │
                                        //  └────────────────────────────────────────────────┘
                                        echo $this->output_today_alert();

                                        //  ┌────────────────────────────────────────────────┐
                                        //  │                     Image                      │
                                        //  └────────────────────────────────────────────────┘
                                        echo $this->output_image($this);
                                ...
                                echo '<div class="tbk-service">';
                                    ...
                                    echo $this->form_description($this); 

                                    // CommandoTemple
                                    if ($this->service_id == 'commandotemple-indoor') { 

                                        echo $this->output_commandotemple();
...
if (!$this->is_checkout && $this->service->getPotentialPrice($this->slot) > 0 && Functions\isThereOneCouponAtLeast()) {
    ...
    //  └───────────────────────────────────────────┘░
    //   ░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░
    public function output_back_arrow(){
    ...
    //  └───────────────────────────────────────────┘░
    //   ░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░
    public function output_today_alert(){
        ob_start();
    ...
    //  └───────────────────────────────────────────┘░
    //   ░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░
    public function output_day_date(){
        ob_start();

        echo '<h4 class="tbk-details__date">';
            echo '<span class="tbk-details__day-and-date">';
                echo $this->slot->getDateFormatted('l, dS M'); 
            echo '</span>';
        echo '</h4>';
    ...
    //  └───────────────────────────────────────────┘░
    //   ░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░
    public function output_start_finish(){
        ob_start();

        if (!empty($this->start_end_times)) { 
            echo '<p class="tbk-details__time tbk-details__time--'. $this->service_id . '">';
            echo $this->start_end_times;
            echo '</p>';
        } 
    ...
    //  └───────────────────────────────────────────┘░
    //   ░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░
    public function output_location(){
        ob_start();

        if (!$this->is_checkout) {  
            $first_address_line = $arr = explode(",", $this->service_location, 2);
    ...
    //  └───────────────────────────────────────────┘░
    //   ░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░
    public function output_price(){
        ob_start();

        echo '<h3 class="tbk-service__price tbk-service__price--'. $this->service_id . '">';
            echo Functions\currencyCodeToSymbol() . $this->slot->getPriceBase();
        echo '</h3>';
    ...
    //  └───────────────────────────────────────────┘░
    //   ░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░
    public function output_title($form){
        ob_start();

        echo '<h1 class="tbk-details__title">';
        echo $form->service->getName(TRUE);
        echo '</h1>'; 
    ...
    //  └───────────────────────────────────────────┘░
    //   ░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░
    public function output_image($form){
        ob_start();

        echo '<div class="tbk-details__image tbk-details__image--'. $this->service_id . '"></div>'; 

        return ob_get_clean();
        
    }

    public function output_form_head(){
        
    }

    //  ┌───────────────────────────────────────────┐ 
    //  │                                           │░
    //  │      NORMAL or CommandoTemple Class?      │░
    //  │                                           │░
    //  └───────────────────────────────────────────┘░
    //   ░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░
    public function output_commandotemple() {
